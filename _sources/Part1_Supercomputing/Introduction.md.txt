...
In this part you will be introduced to key supercomputing concepts with an overview of High Performance Computing (HPC), highlighting the evolution of supercomputers and their impact on scientific research, engineering and societal advancements. We will also introduce you to some of the key terminology and the basics of computing along the way. 
